...
import { Menu, X, ChevronDown, Phone, UserPlus, Calendar, Clock, User, Mail, Target, XCircle } from 'lucide-react';
...
const Navbar = () => {
  ...
  const handleSubmit = (e) => {
    ...
    alert('Consultation requested successfully! We\'ll contact you shortly.');
  ...
  return (
    <>
      <nav className={`fixed w-full z-50 transition-all duration-500 font-['Poppins'] ${
        scrolled ? 'bg-white/90 backdrop-blur-md py-3 shadow-lg shadow-gray-200/50' : 'bg-white py-5 border-b border-gray-100'
      }`}>
        <style>{`
            ...
            <Link to="/" className="flex items-center group cursor-pointer">
              <div className="relative">
                <div className="w-12 h-12 bg-gradient-to-br from-orange-600 to-orange-700 rounded-2xl rotate-3 group-hover:rotate-6 transition-transform duration-300 flex items-center justify-center shadow-lg shadow-orange-500/20">
                  <span className="text-white font-bold text-xl -rotate-3 group-hover:-rotate-6 transition-transform">FFL</span>
                </div>
              ...
              <div className="ml-3">
                <h1 className="text-xl font-bold text-gray-900 tracking-tight leading-none">FITNESS</h1>
                <p className="text-[10px] font-semibold text-orange-600 tracking-[0.2em] uppercase">For Life</p>
              </div>
            </Link>
                  ...
                  {item.hasDropdown ? (
                    ...
                    >
                      ...
                      >
                        ...
                        <ChevronDown size={16} className={`transition-transform duration-300 ${isServicesOpen ? 'rotate-180 text-orange-600' : ''}`} />
                      </Link>

                      {/* Dropdown Menu */}
                      <div className={`absolute top-full -left-4 w-72 pt-4 transition-all duration-300 ${isServicesOpen ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4 pointer-events-none'}`}>
        ...
        {/* Mobile Menu */}
        <div className={`fixed inset-x-0 top-[72px] p-4 lg:hidden transition-all duration-300 ${isOpen ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-10 pointer-events-none'}`}>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm mt-1">
                      Tell us about your goals and we'll help create a personalized plan for you.
                    </p>
                  </div>
                </div>
              </div>
